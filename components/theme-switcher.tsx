...
export function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      className="theme-switcher fixed right-48 top-4 z-50 inline-flex h-10 items-center gap-2 rounded-full border border-border/70 bg-card/85 px-3.5 text-xs font-semibold tracking-wide text-muted-foreground shadow-lg backdrop-blur-xl transition duration-300 hover:-translate-y-0.5 hover:border-primary/50 hover:text-foreground"
    >
